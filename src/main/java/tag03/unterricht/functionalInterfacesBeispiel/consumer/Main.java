...
public class Main {
    ...
    public static void main(String[] args) {
        // Das FuntktionalInterface Consumer kann man da einsetzen wo man Parameter vergibt aber keinen Rückgabewert erwartet.
        ...
        //ObjIntConsumer<String> bic2 = (c, d) -> System.out.println(c + "=" + (d + d));
